...
//spicy peppers, optics, and syrup
namespace WICSGame
{
    ...
    {//System.Media.SoundPlayer
        ...
        public void makeButtons()
        {
            ...
            panelGame.Height = yspaceneeded;
            panelGame.Width = xspaceneeded;
        ...
        protected override void OnMouseDown(MouseEventArgs e)
        {
            ...
            {
                Point loc = System.Windows.Forms.Cursor.Position;
                rightclick = true;
                //MouseEventArgs force = new MouseEventArgs(MouseButtons.Left, 1, loc.X, loc.Y, 0);
                //OnMouseDown(force);
            }
            else
            {
